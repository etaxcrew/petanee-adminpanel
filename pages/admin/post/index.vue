        ...
        <div class="card-body">
          <div class="form-group">
            <div class="input-group mb-3">
              ...
              <input type="text" class="form-control" v-model="search" @keypress.enter="searchData" placeholder="cari berdasarkan nama tag">
          ...
          <b-table striped bordered hover :items="posts" :fields="fields" show-empty>
              ...
              <b-button :to="{name: 'admin-post-edit-id', params: {id: row.item.id}}" variant="warning" size="sm">EDIT</b-button>
              <b-button variant="danger" size="sm" @click="deletePost(row.item.id)">DELETE</b-button>
            </template>
          </b-table>
