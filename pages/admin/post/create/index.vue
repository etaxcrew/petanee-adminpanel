    ...
    <section class="content">
      <div class="card card-outline card-info">
        <div class="card-header">
          <h3 class="card-title"><i class="nav-icon fas fa-book-open"></i> TAMBAH POST</h3>
        ...
        <div class="card-body">
          <form @submit.prevent="storePost">
            ...
            <div class="form-group">
              <label>TAGS</label>
              <multiselect v-model="post.tags" :options="tags" label="name" track-by="id" :multiple="true" :searchable="true">
              </multiselect>
            </div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        editorConfig: {
          removePlugins: ['Title'],
          simpleUpload: {
            uploadUrl: 'https://petanee.webdinamis.id/api/web/posts/storeImage'
          }
        }
      }
    },
    ...
    methods: {
      ...
      async storePost() {
        ...
        await this.$axios.post('/api/admin/posts', formData)
          .then(() => {
